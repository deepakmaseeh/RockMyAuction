    ...
    <div className="bg-[#18181B] rounded-xl border border-[#232326] hover:border-orange-500/30 transition-all overflow-hidden">
      <div className="p-6">
        <div className="flex gap-4">
          {/* Image */}
          <div className="w-24 h-24 bg-[#232326] rounded-lg overflow-hidden flex-shrink-0">
            <img
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
              <div>
                ...
                <div className="font-bold text-white">${listing.startingBid.toLocaleString()}</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="font-bold text-blue-400">{listing.bids}</div>
              </div>
              <div>
                <div className="text-xs text-gray-400">Views</div>
                <div className="font-bold text-purple-400">{listing.views}</div>
              </div>
              <div>
                <div className="text-xs text-gray-400">Time Left</div>
                <div className="font-bold text-white">{listing.timeLeft}</div>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-[#09090B] text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold mb-2">Active Listings</h1>
            <p className="text-gray-400">Manage your live auctions and track their performance</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-[#18181B] rounded-xl p-6 border border-[#232326]">
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-400">{listings.length}</div>
              <div className="text-sm text-gray-400">Total Active</div>
            </div>
          </div>
          <div className="bg-[#18181B] rounded-xl p-6 border border-[#232326]">
            <div className="text-center">
              <div className="text-3xl font-bold text-green-400">{listings.filter(l => l.status === 'LIVE' && l.bids > 0).length}</div>
              <div className="text-sm text-gray-400">With Bids</div>
            </div>
          </div>
          <div className="bg-[#18181B] rounded-xl p-6 border border-[#232326]">
            <div className="text-center">
              <div className="text-3xl font-bold text-yellow-400">{listings.filter(l => l.status === 'NO_BIDS').length}</div>
              <div className="text-sm text-gray-400">No Bids</div>
            </div>
          </div>
          <div className="bg-[#18181B] rounded-xl p-6 border border-[#232326]">
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-400">{listings.reduce((sum, l) => sum + l.views, 0)}</div>
        ...
        {paginatedListings.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 mb-8">Try adjusting your filters or create your first listing</p>
            <Link
              href="/seller/new-auction"
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-[#232326] hover:bg-[#2a2a2e] disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg transition"
                >
                  Previous
                </button>
